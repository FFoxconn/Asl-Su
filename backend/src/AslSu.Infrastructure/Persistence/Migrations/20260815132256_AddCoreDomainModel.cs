    ...
    public partial class AddCoreDomainModel : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "BatchRequestLogs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BatchRequestId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    FailureReasonsJson = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchRequestLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TgoBrandId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TgoCategoryId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BatchRequestId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    TgoProductId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TgoBarcode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TgoSyncStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TgoLastSyncDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TgoLastError = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    WorkflowStatus = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    InvoiceAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    InvoiceTaxAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    BagCount = table.Column<int>(type: "int", nullable: true),
                    ReceiptLink = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSyncedQuantity = table.Column<int>(type: "int", nullable: true),
                    LastSyncedSalePrice = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    LastSyncedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreProductInventories", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubstitutedForBarcode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatchRequestLogs_BatchRequestId",
                table: "BatchRequestLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreProductInventories_ProductId_StoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WebhookLogs_ExternalEventId",
                table: "WebhookLogs",
