                ...
                : RefreshIndicator(
                    ...
                    child: _orders.isEmpty
                        ? ListView(
                            children: const [
                              SizedBox(height: 100),
                              Center(child: Text('Şu anda atanmış siparişin yok.', style: TextStyle(color: mutedColor))),
                            ],
                          )
                        : ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final isDelivering = _deliveringId == order.id;
                              return Card(
                                child: Padding(
                                      ...
                                      if (canDeliver) ...[
                                        ...
                                        SizedBox(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: isDelivering ? null : () => _deliver(order.id),
                                            child: isDelivering
                                                ? const SizedBox(
                                                    width: 18,
                                                    height: 18,
